...
classifier.add(Dense(units = 2, kernel_initializer = 'uniform', activation = 'relu', input_dim = 7))
...
classifier.fit(passenger, is_alive, batch_size = 1, epochs = 2)

# Predicting the probabilities of survival
y_pred = classifier.predict(passenger)
